...
Each constructor additionally takes an \lean{ex\_info} record for auxiliary information used to construct correctness proofs.
...
Coefficients must also be handled correctly in exponents: $x ^ {a * b^2 * 1} * x ^ {a * b^2 * 2} %
% = x ^ {a * b^2 * 1 + a * b^2 * 2}
= x ^ {a * b^2 * 3}$.
